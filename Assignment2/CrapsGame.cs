...
namespace Assignment2
{
        ...
        public static void Main(string[] args)
   {
       ...
       bool validWager;
            ...
            Console.WriteLine("Your current balance is $" + balance + ". Place your wager:");
            ...
            {
                Console.WriteLine(Environment.NewLine + "You only have $" + balance + ". Enter a valid wager:");
                wager = int.Parse(Console.ReadLine());
            }


       Status gameStatus = game.PlayGame();
       // display won or lost message
       if (gameStatus == Status.WON)
            { 
                balance = balance + wager;
                Console.WriteLine(Environment.NewLine + "You won! You now have $" + balance + "." );
            }
       else
            {
                balance = balance - wager;
           if (balance > 0)
                Console.WriteLine(Environment.NewLine + "You lost! You now have $" + balance + ".");
           else 
               Console.WriteLine(Environment.NewLine + "You now have $" + balance + ". Sorry, you busted!");
            }
